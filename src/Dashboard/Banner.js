    ...
    >
      ...
      >
        ...
        >
          <Button>
            <Link href="AllClasses">
              <div>
                <SchoolIcon className={classes.icons}></SchoolIcon>{" "}
                <Typography className={classes.text} style={{ marginTop: 40 }}>
                  All Classes
                </Typography>
              </div>
            </Link>
        ...
        <Box
          ...
          border={1}
          borderRadius={80}
          style={{ height: 140, marginLeft: 130, width: 140 }}
        >
          <Button>
            <Link href="ClassPage">
              <div>
                <ClassIcon className={classes.icons}></ClassIcon>{" "}
                <Typography className={classes.text} style={{ marginTop: 40 }}>
                  {" "}
                  Class Page
                </Typography>
        ...
        >
          <Button>
            <Link href="StudentDirectory">
              <div>
                <PeopleIcon className={classes.icons}></PeopleIcon>{" "}
                <Typography className={classes.text} style={{ marginTop: 30 }}>
                  {" "}
                  Student Directory
                </Typography>
              </div>
        ...
        >
          <Button>
            <Link href="Calendar">
              <div>
                <DateRangeIcon className={classes.icons}></DateRangeIcon>{" "}
                <Typography className={classes.text} style={{ marginTop: 30 }}>
                  {" "}
                  School Calendar
                </Typography>
