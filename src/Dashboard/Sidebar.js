    ...
    <div className={classes.root}>
      ...
      <div className={classes.topPush} style={{ display: "flex" }}>
        ...
        <div style={{ textAlign: "left", marginLeft: 50 }}>
          <Typography style={{ marginLeft: 0 }} className={classes.type}>
            THOMAS JEFFERSON ELEMENTARY SCHOOL
          </Typography>
          <span className={classes.smalltext} style={{ marginRight: 0 }}>
    ...
    <Typography style={{ marginTop: 7}}> Team 8; Updated June 3rd, 2021</Typography> */}
      ...
      >
        ...
        <List>
          ...
          <ListItem
            onClick={onItemClick("All Classes")}
            button
            component={Link}
            to="/AllClasses"
            button
          ...
          >
            <ListItemIcon>
              <SchoolIcon style={{ color: grey[50] }} />
            </ListItemIcon>
            <ListItemText
              classes={{ primary: classes.listItemText }}
              primary="All Classes"
          ...
          <ListItem
            onClick={onItemClick("Class Page")}
            button
            component={Link}
            to="/ClassPage"
            button
          ...
          <ListItem
            onClick={onItemClick("Student Directory")}
            button
            component={Link}
            to="/StudentDirectory"
            button
          ...
          <ListItem
            onClick={onItemClick("Teacher Directory")}
            button
            component={Link}
            to="/TeacherDirectory"
            button
          ...
          >
            <ListItemIcon>
              <PermContactCalendarIcon style={{ color: grey[50] }} />
            </ListItemIcon>
            <ListItemText
              classes={{ primary: classes.listItemText }}
              primary="Teacher Directory"
            ></ListItemText>
          </ListItem>
          <ListItem
            onClick={onItemClick("School Calendar")}
            button
            component={Link}
            to="/Calendar"
            button
